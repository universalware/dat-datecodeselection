 ...
 * generated in the de.dat.datecodeselection.services.authentication package. 
...
public class ObjectFactory {
    ...
    private final static QName _DoLoginRequestProductVariant_QNAME = new QName("", "productVariant");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: de.dat.datecodeselection.services.authentication
     * 
     */
    ...
    public JAXBElement<String> createDoLoginRequestProductVariant(String value) {
        return new JAXBElement<String>(_DoLoginRequestProductVariant_QNAME, String.class, DoLoginRequest.class, value);
    }
    ...
    public JAXBElement<String> createGenerateTokenRequestProductVariant(String value) {
        return new JAXBElement<String>(_DoLoginRequestProductVariant_QNAME, String.class, GenerateTokenRequest.class, value);
    }
