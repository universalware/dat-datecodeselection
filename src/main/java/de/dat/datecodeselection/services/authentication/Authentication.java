...
public interface Authentication {
     ...
     * @param arg0
     * @return
     *     returns de.dat.datecodeselection.services.authentication.DatCredentials
     */
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "authenticateUser", targetNamespace = "http://sphinx.dat.de/services/Authentication", className = "de.dat.datecodeselection.services.authentication.AuthenticateUser")
    @ResponseWrapper(localName = "authenticateUserResponse", targetNamespace = "http://sphinx.dat.de/services/Authentication", className = "de.dat.datecodeselection.services.authentication.AuthenticateUserResponse")
    ...
    @RequestWrapper(localName = "doLogout", targetNamespace = "http://sphinx.dat.de/services/Authentication", className = "de.dat.datecodeselection.services.authentication.DoLogout")
    @ResponseWrapper(localName = "doLogoutResponse", targetNamespace = "http://sphinx.dat.de/services/Authentication", className = "de.dat.datecodeselection.services.authentication.DoLogoutResponse")
    ...
    @ResponseWrapper(localName = "doLoginResponse", targetNamespace = "http://sphinx.dat.de/services/Authentication", className = "de.dat.datecodeselection.services.authentication.DoLoginResponse")
