 ...
 *         &lt;element name="ValueInPositions" type="{http://www.dat.de/vxs}fieldBoolean" minOccurs="0" form="qualified"/>
 *         &lt;element name="ValueForInformation" type="{http://www.dat.de/vxs}fieldBoolean" minOccurs="0" form="qualified"/>
 *       &lt;/all>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class LacquerConstant {
    ...
    @XmlElement(name = "ValueInPositions")
    protected FieldBoolean valueInPositions;
    @XmlElement(name = "ValueForInformation")
    protected FieldBoolean valueForInformation;
    ...
    /**
     * Ruft den Wert der valueInPositions-Eigenschaft ab.
     * 
     * @return
     *     possible object is
     *     {@link FieldBoolean }
     *     
     */
    public FieldBoolean getValueInPositions() {
        return valueInPositions;
    }

    /**
     * Legt den Wert der valueInPositions-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link FieldBoolean }
     *     
     */
    public void setValueInPositions(FieldBoolean value) {
        this.valueInPositions = value;
    }

    /**
     * Ruft den Wert der valueForInformation-Eigenschaft ab.
     * 
     * @return
     *     possible object is
     *     {@link FieldBoolean }
     *     
     */
    public FieldBoolean getValueForInformation() {
        return valueForInformation;
    }

    /**
     * Legt den Wert der valueForInformation-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link FieldBoolean }
     *     
     */
    public void setValueForInformation(FieldBoolean value) {
        this.valueForInformation = value;
    }
