 ...
 *         &lt;element name="TotalWages" type="{http://www.dat.de/vxs}fieldDecimal" minOccurs="0" form="qualified"/>
 *         &lt;element name="DentsCivdWage" type="{http://www.dat.de/vxs}detailBlockSummary" minOccurs="0" form="qualified"/>
 *         &lt;element name="DentsCivdMaterial" type="{http://www.dat.de/vxs}detailBlockSummary" minOccurs="0" form="qualified"/>
...
public class LacquerCostsSummary {
    ...
    @XmlElement(name = "TotalWages")
    protected FieldDecimal totalWages;
    @XmlElement(name = "DentsCivdWage")
    protected DetailBlockSummary dentsCivdWage;
    @XmlElement(name = "DentsCivdMaterial")
    protected DetailBlockSummary dentsCivdMaterial;
    ...
    /**
     * Ruft den Wert der totalWages-Eigenschaft ab.
     * 
     * @return
     *     possible object is
     *     {@link FieldDecimal }
     *     
     */
    public FieldDecimal getTotalWages() {
        return totalWages;
    }

    /**
     * Legt den Wert der totalWages-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link FieldDecimal }
     *     
     */
    public void setTotalWages(FieldDecimal value) {
        this.totalWages = value;
    }

    /**
     * Ruft den Wert der dentsCivdWage-Eigenschaft ab.
     * 
     * @return
     *     possible object is
     *     {@link DetailBlockSummary }
     *     
     */
    public DetailBlockSummary getDentsCivdWage() {
        return dentsCivdWage;
    }

    /**
     * Legt den Wert der dentsCivdWage-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link DetailBlockSummary }
     *     
     */
    public void setDentsCivdWage(DetailBlockSummary value) {
        this.dentsCivdWage = value;
    }

    /**
     * Ruft den Wert der dentsCivdMaterial-Eigenschaft ab.
     * 
     * @return
     *     possible object is
     *     {@link DetailBlockSummary }
     *     
     */
    public DetailBlockSummary getDentsCivdMaterial() {
        return dentsCivdMaterial;
    }

    /**
     * Legt den Wert der dentsCivdMaterial-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link DetailBlockSummary }
     *     
     */
    public void setDentsCivdMaterial(DetailBlockSummary value) {
        this.dentsCivdMaterial = value;
    }
