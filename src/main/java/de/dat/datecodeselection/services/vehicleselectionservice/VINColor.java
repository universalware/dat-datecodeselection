 ...
 *         &lt;element name="PaintType" type="{http://www.dat.de/vxs}fieldString" minOccurs="0" form="qualified"/>
 *         &lt;element name="CountCoat" type="{http://www.dat.de/vxs}fieldString" minOccurs="0" form="qualified"/>
 *       &lt;/all>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class VINColor {
    ...
    protected FieldString paintType;
    @XmlElement(name = "CountCoat")
    protected FieldString countCoat;
    ...
    /**
     * Ruft den Wert der paintType-Eigenschaft ab.
     * 
     * @return
     *     possible object is
     *     {@link FieldString }
     *     
     */
    public FieldString getPaintType() {
        return paintType;
    }

    /**
     * Legt den Wert der paintType-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link FieldString }
     *     
     */
    public void setPaintType(FieldString value) {
        this.paintType = value;
    }

    /**
     * Ruft den Wert der countCoat-Eigenschaft ab.
     * 
     * @return
     *     possible object is
     *     {@link FieldString }
     *     
     */
    public FieldString getCountCoat() {
        return countCoat;
    }

    /**
     * Legt den Wert der countCoat-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link FieldString }
     *     
     */
    public void setCountCoat(FieldString value) {
        this.countCoat = value;
    }
