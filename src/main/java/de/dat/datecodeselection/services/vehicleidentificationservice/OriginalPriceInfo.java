 ...
 *         &lt;element name="OriginalPriceNoVARate" type="{http://www.dat.de/vxs}fieldDecimal" minOccurs="0" form="qualified"/>
 *         &lt;element name="DatOriginalPriceNoVARate" type="{http://www.dat.de/vxs}fieldDecimal" minOccurs="0" form="qualified"/>
...
public class OriginalPriceInfo {
    ...
    @XmlElement(name = "OriginalPriceNoVARate")
    protected FieldDecimal originalPriceNoVARate;
    @XmlElement(name = "DatOriginalPriceNoVARate")
    protected FieldDecimal datOriginalPriceNoVARate;
    ...
    /**
     * Ruft den Wert der originalPriceNoVARate-Eigenschaft ab.
     * 
     * @return
     *     possible object is
     *     {@link FieldDecimal }
     *     
     */
    public FieldDecimal getOriginalPriceNoVARate() {
        return originalPriceNoVARate;
    }

    /**
     * Legt den Wert der originalPriceNoVARate-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link FieldDecimal }
     *     
     */
    public void setOriginalPriceNoVARate(FieldDecimal value) {
        this.originalPriceNoVARate = value;
    }

    /**
     * Ruft den Wert der datOriginalPriceNoVARate-Eigenschaft ab.
     * 
     * @return
     *     possible object is
     *     {@link FieldDecimal }
     *     
     */
    public FieldDecimal getDatOriginalPriceNoVARate() {
        return datOriginalPriceNoVARate;
    }

    /**
     * Legt den Wert der datOriginalPriceNoVARate-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link FieldDecimal }
     *     
     */
    public void setDatOriginalPriceNoVARate(FieldDecimal value) {
        this.datOriginalPriceNoVARate = value;
    }
