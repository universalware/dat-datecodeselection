 ...
 *         &lt;element name="VinDatProcedure" type="{http://www.dat.de/vxs}fieldBoolean" minOccurs="0" form="qualified"/>
 *         &lt;element name="CrossBorder" type="{http://www.dat.de/vxs}fieldBoolean" minOccurs="0" form="qualified"/>
...
public class VINResult {
    ...
    @XmlElement(name = "VinDatProcedure")
    protected FieldBoolean vinDatProcedure;
    @XmlElement(name = "CrossBorder")
    protected FieldBoolean crossBorder;
    ...
    /**
     * Ruft den Wert der vinDatProcedure-Eigenschaft ab.
     * 
     * @return
     *     possible object is
     *     {@link FieldBoolean }
     *     
     */
    public FieldBoolean getVinDatProcedure() {
        return vinDatProcedure;
    }

    /**
     * Legt den Wert der vinDatProcedure-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link FieldBoolean }
     *     
     */
    public void setVinDatProcedure(FieldBoolean value) {
        this.vinDatProcedure = value;
    }
     ...
     *     
     */
    public FieldBoolean getCrossBorder() {
        return crossBorder;
    }
     ...
     *     
     */
    public void setCrossBorder(FieldBoolean value) {
