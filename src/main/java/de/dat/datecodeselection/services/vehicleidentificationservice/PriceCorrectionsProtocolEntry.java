 ...
 *         &lt;element name="PriceCorrection" type="{http://www.dat.de/vxs}fieldDecimal" minOccurs="0" form="qualified"/>
 *       &lt;/all>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "PriceCorrectionsProtocolEntry")
public class PriceCorrectionsProtocolEntry {
    ...
    @XmlElement(name = "PriceCorrection")
    protected FieldDecimal priceCorrection;
    ...
    /**
     * Ruft den Wert der priceCorrection-Eigenschaft ab.
     * 
     * @return
     *     possible object is
     *     {@link FieldDecimal }
     *     
     */
    public FieldDecimal getPriceCorrection() {
        return priceCorrection;
    }

    /**
     * Legt den Wert der priceCorrection-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link FieldDecimal }
     *     
     */
    public void setPriceCorrection(FieldDecimal value) {
