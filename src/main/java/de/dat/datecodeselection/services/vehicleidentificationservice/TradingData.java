 ...
 *         &lt;element name="Buyer" type="{http://www.dat.de/vxs}address" minOccurs="0" form="qualified"/>
 ...
 *         &lt;element name="InsuranceBroker" type="{http://www.dat.de/vxs}address" minOccurs="0" form="qualified"/>
...
public class TradingData {
    ...
    @XmlElement(name = "InsuranceBroker")
    protected Address insuranceBroker;
     ...
     *     
     */
    public void setBuyer(Address value) {
        this.buyer = value;
    }
    ...
    /**
     * Ruft den Wert der insuranceBroker-Eigenschaft ab.
     * 
     * @return
     *     possible object is
     *     {@link Address }
     *     
     */
    public Address getInsuranceBroker() {
        return insuranceBroker;
    }

    /**
     * Legt den Wert der insuranceBroker-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link Address }
     *     
     */
    public void setInsuranceBroker(Address value) {
        this.insuranceBroker = value;
    }
