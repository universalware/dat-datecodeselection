 ...
 *         &lt;element name="PurchaseOfferList" minOccurs="0" form="qualified">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
 *                   &lt;element ref="{http://www.dat.de/vxs}PurchaseOffer" maxOccurs="unbounded" minOccurs="0"/>
 *                 &lt;/sequence>
 *               &lt;/restriction>
 *             &lt;/complexContent>
 *           &lt;/complexType>
...
public class TradingAdditional {
    ...
    @XmlElement(name = "PurchaseOfferList")
    protected TradingAdditional.PurchaseOfferList purchaseOfferList;
    ...
    /**
     * Ruft den Wert der purchaseOfferList-Eigenschaft ab.
     * 
     * @return
     *     possible object is
     *     {@link TradingAdditional.PurchaseOfferList }
     *     
     */
    public TradingAdditional.PurchaseOfferList getPurchaseOfferList() {
        return purchaseOfferList;
    }

    /**
     * Legt den Wert der purchaseOfferList-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link TradingAdditional.PurchaseOfferList }
     *     
     */
    public void setPurchaseOfferList(TradingAdditional.PurchaseOfferList value) {
        this.purchaseOfferList = value;
    }
    ...
    public static class PurchaseOfferList {

        @XmlElement(name = "PurchaseOffer")
        protected List<PurchaseOffer> purchaseOffer;
         ...
         * 
         */
        public List<PurchaseOffer> getPurchaseOffer() {
            if (purchaseOffer == null) {
                purchaseOffer = new ArrayList<PurchaseOffer>();
            }
