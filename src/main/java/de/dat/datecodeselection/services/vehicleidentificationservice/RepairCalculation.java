 ...
 *         &lt;element name="CalcResultExtension" type="{http://www.dat.de/vxs}calcResult" minOccurs="0" form="qualified"/>
 ...
 *         &lt;element ref="{http://www.dat.de/vxs}SettingsParameters" minOccurs="0"/>
 *       &lt;/all>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class RepairCalculation {
    ...
    @XmlElement(name = "CalcResultExtension")
    protected CalcResult calcResultExtension;
    ...
    @XmlElement(name = "SettingsParameters")
    protected SettingsParameters settingsParameters;
    ...
    /**
     * Ruft den Wert der calcResultExtension-Eigenschaft ab.
     * 
     * @return
     *     possible object is
     *     {@link CalcResult }
     *     
     */
    public CalcResult getCalcResultExtension() {
        return calcResultExtension;
    }

    /**
     * Legt den Wert der calcResultExtension-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link CalcResult }
     *     
     */
    public void setCalcResultExtension(CalcResult value) {
        this.calcResultExtension = value;
    }
    ...
    /**
     * Ruft den Wert der settingsParameters-Eigenschaft ab.
     * 
     * @return
     *     possible object is
     *     {@link SettingsParameters }
     *     
     */
    ...
    /**
     * Legt den Wert der settingsParameters-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link SettingsParameters }
     *     
     */
    public void setSettingsParameters(SettingsParameters value) {
        this.settingsParameters = value;
    }
