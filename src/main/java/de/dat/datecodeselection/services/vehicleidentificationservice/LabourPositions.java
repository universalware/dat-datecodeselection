 ...
 *         &lt;element name="DentHUKPosition" type="{http://www.dat.de/vxs}LabourPosition" maxOccurs="unbounded" minOccurs="0" form="qualified"/>
...
public class LabourPositions {
    ...
    @XmlElement(name = "DentHUKPosition")
    protected List<LabourPosition> dentHUKPosition;
    ...
    /**
     * Gets the value of the dentHUKPosition property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the dentHUKPosition property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDentHUKPosition().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<LabourPosition> getDentHUKPosition() {
        if (dentHUKPosition == null) {
            dentHUKPosition = new ArrayList<LabourPosition>();
        }
        return this.dentHUKPosition;
    }
