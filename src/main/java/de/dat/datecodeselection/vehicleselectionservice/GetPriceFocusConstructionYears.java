...
/**
 * <p>Java-Klasse für getPriceFocusConstructionYears complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="getPriceFocusConstructionYears">
 *   &lt;complexContent>
...
@XmlType(name = "getPriceFocusConstructionYears", namespace = "http://sphinx.dat.de/services/VehicleSelectionService", propOrder = {
    "request"
})
public class GetPriceFocusConstructionYears {
