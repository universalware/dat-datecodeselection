 ...
 *         &lt;element name="DentCivdPosition" type="{http://www.dat.de/vxs}LacquerPosition" maxOccurs="unbounded" minOccurs="0" form="qualified"/>
...
public class LacquerPositions {
    ...
    @XmlElement(name = "DentCivdPosition")
    protected List<LacquerPosition> dentCivdPosition;
    ...
    /**
     * Gets the value of the dentCivdPosition property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the dentCivdPosition property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDentCivdPosition().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<LacquerPosition> getDentCivdPosition() {
        if (dentCivdPosition == null) {
            dentCivdPosition = new ArrayList<LacquerPosition>();
        }
        return this.dentCivdPosition;
    }
