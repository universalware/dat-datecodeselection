...
/**
 * <p>Java-Klasse für getHgvPlatformAggregateModelDataResponse complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="getHgvPlatformAggregateModelDataResponse">
 *   &lt;complexContent>
...
@XmlType(name = "getHgvPlatformAggregateModelDataResponse", namespace = "http://sphinx.dat.de/services/VehicleSelectionService", propOrder = {
    "vxs"
})
public class GetHgvPlatformAggregateModelDataResponse {

    @XmlElement(name = "VXS", namespace = "")
    protected GetHgvPlatformAggregateModelDataResponse.VXS vxs;
     ...
     * @return
     *     possible object is
     *     {@link GetHgvPlatformAggregateModelDataResponse.VXS }
     *     
     */
    public GetHgvPlatformAggregateModelDataResponse.VXS getVXS() {
        return vxs;
    }
     ...
     *     
     */
    public void setVXS(GetHgvPlatformAggregateModelDataResponse.VXS value) {
        this.vxs = value;
    }
    ...
    public static class VXS {
        ...
        @XmlElement(name = "Name", namespace = "http://sphinx.dat.de/services/VehicleSelectionService")
        protected FieldString name;
        @XmlElement(name = "Description", namespace = "http://sphinx.dat.de/services/VehicleSelectionService")
        protected FieldString description;
        @XmlElement(name = "UUID", namespace = "http://sphinx.dat.de/services/VehicleSelectionService")
        protected FieldString uuid;
        @XmlElement(name = "ExternalId", namespace = "http://sphinx.dat.de/services/VehicleSelectionService")
        protected FieldString externalId;
        @XmlElement(name = "IdSD2", namespace = "http://sphinx.dat.de/services/VehicleSelectionService")
        protected FieldString12 idSD2;
        @XmlElement(name = "IdSDo", namespace = "http://sphinx.dat.de/services/VehicleSelectionService")
        protected FieldInteger idSDo;
        @XmlElement(name = "IdSD3Local", namespace = "http://sphinx.dat.de/services/VehicleSelectionService")
        protected FieldInteger idSD3Local;
        @XmlElement(name = "DossierId", namespace = "http://sphinx.dat.de/services/VehicleSelectionService")
        protected FieldInteger dossierId;
        @XmlElement(name = "IdSD3Network", namespace = "http://sphinx.dat.de/services/VehicleSelectionService")
        protected FieldInteger idSD3Network;
        @XmlElement(name = "IdExtern", namespace = "http://sphinx.dat.de/services/VehicleSelectionService")
        protected FieldString40 idExtern;
        @XmlElement(name = "Country", namespace = "http://sphinx.dat.de/services/VehicleSelectionService", required = true)
        protected FieldString3 country;
        @XmlElement(name = "Language", namespace = "http://sphinx.dat.de/services/VehicleSelectionService", required = true)
        protected FieldString5 language;
        @XmlElement(name = "DataVersion", namespace = "http://sphinx.dat.de/services/VehicleSelectionService")
        protected FieldDecimal dataVersion;
        @XmlElement(name = "Currency", namespace = "http://sphinx.dat.de/services/VehicleSelectionService")
        protected FieldString3 currency;
        @XmlElement(name = "DatCustomerId", namespace = "http://sphinx.dat.de/services/VehicleSelectionService")
        protected FieldString10 datCustomerId;
        @XmlElement(name = "MerchandId", namespace = "http://sphinx.dat.de/services/VehicleSelectionService")
        protected FieldDecimal merchandId;
        @XmlElement(name = "DossierType", namespace = "http://sphinx.dat.de/services/VehicleSelectionService")
        protected FieldString dossierType;
        @XmlElement(name = "DossierOrigin", namespace = "http://sphinx.dat.de/services/VehicleSelectionService")
        protected FieldString dossierOrigin;
        @XmlElement(name = "CreateDate", namespace = "http://sphinx.dat.de/services/VehicleSelectionService")
        protected FieldDateTime createDate;
        @XmlElement(name = "CreateUser", namespace = "http://sphinx.dat.de/services/VehicleSelectionService")
        protected FieldString createUser;
        @XmlElement(name = "ChangeDate", namespace = "http://sphinx.dat.de/services/VehicleSelectionService")
        protected FieldDateTime changeDate;
        @XmlElement(name = "ChangeUser", namespace = "http://sphinx.dat.de/services/VehicleSelectionService")
        protected FieldString changeUser;
        @XmlElement(name = "CDYear", namespace = "http://sphinx.dat.de/services/VehicleSelectionService")
        protected FieldInteger cdYear;
        @XmlElement(name = "CDMonth", namespace = "http://sphinx.dat.de/services/VehicleSelectionService")
        protected FieldInteger cdMonth;
        @XmlElement(name = "DatCustomerAddress", namespace = "http://sphinx.dat.de/services/VehicleSelectionService")
        ...
        @XmlElement(name = "VAT")
        protected VAT vat;
        @XmlElement(name = "Management", namespace = "http://sphinx.dat.de/services/VehicleSelectionService")
        ...
        @XmlElement(name = "ChangeUserId", namespace = "http://sphinx.dat.de/services/VehicleSelectionService")
        protected FieldInteger changeUserId;
        @XmlElement(name = "CreateUserId", namespace = "http://sphinx.dat.de/services/VehicleSelectionService")
        protected FieldInteger createUserId;
        @XmlElement(name = "WearCalculation", namespace = "http://sphinx.dat.de/services/VehicleSelectionService")
        protected FieldBoolean wearCalculation;
        @XmlElement(name = "InsuranceClaim", namespace = "http://sphinx.dat.de/services/VehicleSelectionService")
