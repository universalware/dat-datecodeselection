...
/**
 * <p>Java-Klasse für getBaseModels complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="getBaseModels">
 *   &lt;complexContent>
...
@XmlType(name = "getBaseModels", namespace = "http://sphinx.dat.de/services/VehicleSelectionService", propOrder = {
    "request"
})
public class GetBaseModels {
