...
/**
 * <p>Java-Klasse für getGrossVehicleWeightOptions complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="getGrossVehicleWeightOptions">
 *   &lt;complexContent>
...
@XmlType(name = "getGrossVehicleWeightOptions", namespace = "http://sphinx.dat.de/services/VehicleSelectionService", propOrder = {
    "request"
})
public class GetGrossVehicleWeightOptions {
