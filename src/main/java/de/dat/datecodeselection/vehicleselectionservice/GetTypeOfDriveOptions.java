...
/**
 * <p>Java-Klasse für getTypeOfDriveOptions complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="getTypeOfDriveOptions">
 *   &lt;complexContent>
...
@XmlType(name = "getTypeOfDriveOptions", namespace = "http://sphinx.dat.de/services/VehicleSelectionService", propOrder = {
    "request"
})
public class GetTypeOfDriveOptions {
