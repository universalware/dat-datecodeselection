...
/**
 * <p>Java-Klasse für getEngineOptions complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="getEngineOptions">
 *   &lt;complexContent>
...
@XmlType(name = "getEngineOptions", namespace = "http://sphinx.dat.de/services/VehicleSelectionService", propOrder = {
    "request"
})
public class GetEngineOptions {
