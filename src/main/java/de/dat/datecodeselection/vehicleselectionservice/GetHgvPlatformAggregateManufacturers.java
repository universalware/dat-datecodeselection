...
/**
 * <p>Java-Klasse für getHgvPlatformAggregateManufacturers complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="getHgvPlatformAggregateManufacturers">
 *   &lt;complexContent>
...
@XmlType(name = "getHgvPlatformAggregateManufacturers", namespace = "http://sphinx.dat.de/services/VehicleSelectionService", propOrder = {
    "request"
})
public class GetHgvPlatformAggregateManufacturers {
