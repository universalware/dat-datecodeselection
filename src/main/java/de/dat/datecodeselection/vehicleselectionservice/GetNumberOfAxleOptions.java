...
/**
 * <p>Java-Klasse für getNumberOfAxleOptions complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="getNumberOfAxleOptions">
 *   &lt;complexContent>
...
@XmlType(name = "getNumberOfAxleOptions", namespace = "http://sphinx.dat.de/services/VehicleSelectionService", propOrder = {
    "request"
})
public class GetNumberOfAxleOptions {
