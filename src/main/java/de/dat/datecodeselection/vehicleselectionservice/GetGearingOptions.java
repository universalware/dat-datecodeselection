...
/**
 * <p>Java-Klasse für getGearingOptions complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="getGearingOptions">
 *   &lt;complexContent>
...
@XmlType(name = "getGearingOptions", namespace = "http://sphinx.dat.de/services/VehicleSelectionService", propOrder = {
    "request"
})
public class GetGearingOptions {
