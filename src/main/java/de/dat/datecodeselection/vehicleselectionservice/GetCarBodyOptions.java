...
/**
 * <p>Java-Klasse für getCarBodyOptions complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="getCarBodyOptions">
 *   &lt;complexContent>
...
@XmlType(name = "getCarBodyOptions", namespace = "http://sphinx.dat.de/services/VehicleSelectionService", propOrder = {
    "request"
})
public class GetCarBodyOptions {
