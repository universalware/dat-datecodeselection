 ...
 *       &lt;sequence>
 *         &lt;element name="locale" type="{http://sphinx.dat.de/services/VehicleSelectionService}locale"/>
...
@XmlType(name = "abstractSelectionRequest", namespace = "http://sphinx.dat.de/services/VehicleSelectionService", propOrder = {
    "locale",
    "sessionID"
})
@XmlSeeAlso({
    HgvPlatformAggregateModelSelectionRequest.class,
