 ...
 *         &lt;element name="RepairAgreementExclVAT" type="{http://www.dat.de/vxs}fieldDecimal" minOccurs="0" form="qualified"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class RepairOrder {
    ...
    @XmlElement(name = "RepairAgreementExclVAT")
    protected FieldDecimal repairAgreementExclVAT;
    ...
    /**
     * Ruft den Wert der repairAgreementExclVAT-Eigenschaft ab.
     * 
     * @return
     *     possible object is
     *     {@link FieldDecimal }
     *     
     */
    public FieldDecimal getRepairAgreementExclVAT() {
        return repairAgreementExclVAT;
    }

    /**
     * Legt den Wert der repairAgreementExclVAT-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link FieldDecimal }
     *     
     */
    public void setRepairAgreementExclVAT(FieldDecimal value) {
        this.repairAgreementExclVAT = value;
    }
