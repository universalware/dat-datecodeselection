...
/**
 * <p>Java-Klasse für getSuspensionOptions complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="getSuspensionOptions">
 *   &lt;complexContent>
...
@XmlType(name = "getSuspensionOptions", namespace = "http://sphinx.dat.de/services/VehicleSelectionService", propOrder = {
    "request"
})
public class GetSuspensionOptions {
