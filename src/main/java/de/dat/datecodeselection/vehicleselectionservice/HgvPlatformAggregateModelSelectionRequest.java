...
/**
 * <p>Java-Klasse für hgvPlatformAggregateModelSelectionRequest complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="hgvPlatformAggregateModelSelectionRequest">
 *   &lt;complexContent>
...
@XmlType(name = "hgvPlatformAggregateModelSelectionRequest", namespace = "http://sphinx.dat.de/services/VehicleSelectionService", propOrder = {
    "manufacturer"
})
@XmlSeeAlso({
    HgvPlatformAggregateModelDataRequest.class
})
public class HgvPlatformAggregateModelSelectionRequest
