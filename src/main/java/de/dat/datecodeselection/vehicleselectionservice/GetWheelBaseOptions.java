...
/**
 * <p>Java-Klasse für getWheelBaseOptions complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="getWheelBaseOptions">
 *   &lt;complexContent>
...
@XmlType(name = "getWheelBaseOptions", namespace = "http://sphinx.dat.de/services/VehicleSelectionService", propOrder = {
    "request"
})
public class GetWheelBaseOptions {
