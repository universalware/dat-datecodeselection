...
/**
 * <p>Java-Klasse für getDriversCabOptions complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="getDriversCabOptions">
 *   &lt;complexContent>
...
@XmlType(name = "getDriversCabOptions", namespace = "http://sphinx.dat.de/services/VehicleSelectionService", propOrder = {
    "request"
})
public class GetDriversCabOptions {
