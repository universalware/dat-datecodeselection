 ...
 *         &lt;element name="ContainedInDATProcessId" type="{http://www.dat.de/vxs}fieldInteger" minOccurs="0" form="qualified"/>
 *         &lt;element name="ContainedInRepairType" type="{http://www.dat.de/vxs}fieldString" minOccurs="0" form="qualified"/>
 *         &lt;element name="ContainedInLacquerLevel" type="{http://www.dat.de/vxs}fieldInteger" minOccurs="0" form="qualified"/>
...
@XmlRootElement(name = "ProtocolEntryWithRemoval")
public class ProtocolEntryWithRemoval {
    ...
    @XmlElement(name = "ContainedInDATProcessId")
    protected FieldInteger containedInDATProcessId;
    @XmlElement(name = "ContainedInRepairType")
    protected FieldString containedInRepairType;
    @XmlElement(name = "ContainedInLacquerLevel")
    protected FieldInteger containedInLacquerLevel;
    ...
    /**
     * Ruft den Wert der containedInDATProcessId-Eigenschaft ab.
     * 
     * @return
     *     possible object is
     *     {@link FieldInteger }
     *     
     */
    public FieldInteger getContainedInDATProcessId() {
        return containedInDATProcessId;
    }

    /**
     * Legt den Wert der containedInDATProcessId-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link FieldInteger }
     *     
     */
    public void setContainedInDATProcessId(FieldInteger value) {
        this.containedInDATProcessId = value;
    }

    /**
     * Ruft den Wert der containedInRepairType-Eigenschaft ab.
     * 
     * @return
     *     possible object is
     *     {@link FieldString }
     *     
     */
    public FieldString getContainedInRepairType() {
        return containedInRepairType;
    }

    /**
     * Legt den Wert der containedInRepairType-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link FieldString }
     *     
     */
    public void setContainedInRepairType(FieldString value) {
        this.containedInRepairType = value;
    }

    /**
     * Ruft den Wert der containedInLacquerLevel-Eigenschaft ab.
     * 
     * @return
     *     possible object is
     *     {@link FieldInteger }
     *     
     */
    public FieldInteger getContainedInLacquerLevel() {
        return containedInLacquerLevel;
    }

    /**
     * Legt den Wert der containedInLacquerLevel-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link FieldInteger }
     *     
     */
    public void setContainedInLacquerLevel(FieldInteger value) {
        this.containedInLacquerLevel = value;
    }
