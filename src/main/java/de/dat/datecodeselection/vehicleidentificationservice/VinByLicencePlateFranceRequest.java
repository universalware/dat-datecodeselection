...
/**
 * <p>Java-Klasse für vinByLicencePlateFranceRequest complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="vinByLicencePlateFranceRequest">
 *   &lt;complexContent>
...
@XmlType(name = "vinByLicencePlateFranceRequest", namespace = "http://sphinx.dat.de/services/VehicleIdentificationService", propOrder = {
    "licencePlate"
})
public class VinByLicencePlateFranceRequest {
