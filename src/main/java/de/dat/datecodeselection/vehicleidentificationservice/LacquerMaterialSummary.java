 ...
 *         &lt;element name="LacquerMaterialManual" type="{http://www.dat.de/vxs}detailBlockSummary" minOccurs="0" form="qualified"/>
 *         &lt;element name="SpotRepairPrice" type="{http://www.dat.de/vxs}fieldDecimal" minOccurs="0" form="qualified"/>
 *         &lt;element name="SpecialLacquerAwardN" type="{http://www.dat.de/vxs}fieldDecimal" minOccurs="0" form="qualified"/>
 ...
 *         &lt;element name="SumMaterialCorrected" type="{http://www.dat.de/vxs}fieldDecimal" minOccurs="0" form="qualified"/>
 *       &lt;/all>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class LacquerMaterialSummary {
    ...
    @XmlElement(name = "LacquerMaterialManual")
    protected DetailBlockSummary lacquerMaterialManual;
    @XmlElement(name = "SpotRepairPrice")
    protected FieldDecimal spotRepairPrice;
    @XmlElement(name = "SpecialLacquerAwardN")
    protected FieldDecimal specialLacquerAwardN;
    ...
    @XmlElement(name = "SumMaterialCorrected")
    protected FieldDecimal sumMaterialCorrected;
    ...
    /**
     * Ruft den Wert der lacquerMaterialManual-Eigenschaft ab.
     * 
     * @return
     *     possible object is
     *     {@link DetailBlockSummary }
     *     
     */
    public DetailBlockSummary getLacquerMaterialManual() {
        return lacquerMaterialManual;
    }

    /**
     * Legt den Wert der lacquerMaterialManual-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link DetailBlockSummary }
     *     
     */
    public void setLacquerMaterialManual(DetailBlockSummary value) {
        this.lacquerMaterialManual = value;
    }
    ...
    /**
     * Ruft den Wert der specialLacquerAwardN-Eigenschaft ab.
     * 
     * @return
     *     possible object is
     *     {@link FieldDecimal }
     *     
     */
    public FieldDecimal getSpecialLacquerAwardN() {
        return specialLacquerAwardN;
    }

    /**
     * Legt den Wert der specialLacquerAwardN-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link FieldDecimal }
     *     
     */
    public void setSpecialLacquerAwardN(FieldDecimal value) {
        this.specialLacquerAwardN = value;
    }
    ...
    /**
     * Ruft den Wert der sumMaterialCorrected-Eigenschaft ab.
     * 
     * @return
     *     possible object is
     *     {@link FieldDecimal }
     *     
     */
    public FieldDecimal getSumMaterialCorrected() {
        return sumMaterialCorrected;
    }

    /**
     * Legt den Wert der sumMaterialCorrected-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link FieldDecimal }
     *     
     */
    public void setSumMaterialCorrected(FieldDecimal value) {
        this.sumMaterialCorrected = value;
    }
