...
/**
 * <p>Java-Klasse für getVehicleIdentificationResponse complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="getVehicleIdentificationResponse">
 *   &lt;complexContent>
 ...
 *                   &lt;element ref="{http://www.dat.de/vxs}TelematicData" minOccurs="0"/>
 *                 &lt;/all>
...
@XmlType(name = "getVehicleIdentificationResponse", namespace = "http://sphinx.dat.de/services/VehicleIdentificationService", propOrder = {
    "vxs"
})
public class GetVehicleIdentificationResponse {

    @XmlElement(name = "VXS", namespace = "")
    protected GetVehicleIdentificationResponse.VXS vxs;
     ...
     * @return
     *     possible object is
     *     {@link GetVehicleIdentificationResponse.VXS }
     *     
     */
    public GetVehicleIdentificationResponse.VXS getVXS() {
        return vxs;
    }
     ...
     *     
     */
    public void setVXS(GetVehicleIdentificationResponse.VXS value) {
        this.vxs = value;
    }
    ...
    public static class VXS {
        ...
        @XmlElement(name = "Name", namespace = "http://sphinx.dat.de/services/VehicleIdentificationService")
        protected FieldString name;
        @XmlElement(name = "Description", namespace = "http://sphinx.dat.de/services/VehicleIdentificationService")
        protected FieldString description;
        @XmlElement(name = "UUID", namespace = "http://sphinx.dat.de/services/VehicleIdentificationService")
        protected FieldString uuid;
        @XmlElement(name = "ExternalId", namespace = "http://sphinx.dat.de/services/VehicleIdentificationService")
        protected FieldString externalId;
        @XmlElement(name = "IdSD2", namespace = "http://sphinx.dat.de/services/VehicleIdentificationService")
        protected FieldString12 idSD2;
        @XmlElement(name = "IdSDo", namespace = "http://sphinx.dat.de/services/VehicleIdentificationService")
        protected FieldInteger idSDo;
        @XmlElement(name = "IdSD3Local", namespace = "http://sphinx.dat.de/services/VehicleIdentificationService")
        protected FieldInteger idSD3Local;
        @XmlElement(name = "DossierId", namespace = "http://sphinx.dat.de/services/VehicleIdentificationService")
        protected FieldInteger dossierId;
        @XmlElement(name = "IdSD3Network", namespace = "http://sphinx.dat.de/services/VehicleIdentificationService")
        protected FieldInteger idSD3Network;
        @XmlElement(name = "IdExtern", namespace = "http://sphinx.dat.de/services/VehicleIdentificationService")
        protected FieldString40 idExtern;
        @XmlElement(name = "Country", namespace = "http://sphinx.dat.de/services/VehicleIdentificationService", required = true)
        protected FieldString3 country;
        @XmlElement(name = "Language", namespace = "http://sphinx.dat.de/services/VehicleIdentificationService", required = true)
        protected FieldString5 language;
        @XmlElement(name = "DataVersion", namespace = "http://sphinx.dat.de/services/VehicleIdentificationService")
        protected FieldDecimal dataVersion;
        @XmlElement(name = "Currency", namespace = "http://sphinx.dat.de/services/VehicleIdentificationService")
        protected FieldString3 currency;
        @XmlElement(name = "DatCustomerId", namespace = "http://sphinx.dat.de/services/VehicleIdentificationService")
        protected FieldString10 datCustomerId;
        @XmlElement(name = "MerchandId", namespace = "http://sphinx.dat.de/services/VehicleIdentificationService")
        protected FieldDecimal merchandId;
        @XmlElement(name = "DossierType", namespace = "http://sphinx.dat.de/services/VehicleIdentificationService")
        protected FieldString dossierType;
        @XmlElement(name = "DossierOrigin", namespace = "http://sphinx.dat.de/services/VehicleIdentificationService")
        protected FieldString dossierOrigin;
        @XmlElement(name = "CreateDate", namespace = "http://sphinx.dat.de/services/VehicleIdentificationService")
        protected FieldDateTime createDate;
        @XmlElement(name = "CreateUser", namespace = "http://sphinx.dat.de/services/VehicleIdentificationService")
        protected FieldString createUser;
        @XmlElement(name = "ChangeDate", namespace = "http://sphinx.dat.de/services/VehicleIdentificationService")
        protected FieldDateTime changeDate;
        @XmlElement(name = "ChangeUser", namespace = "http://sphinx.dat.de/services/VehicleIdentificationService")
        protected FieldString changeUser;
        @XmlElement(name = "CDYear", namespace = "http://sphinx.dat.de/services/VehicleIdentificationService")
        protected FieldInteger cdYear;
        @XmlElement(name = "CDMonth", namespace = "http://sphinx.dat.de/services/VehicleIdentificationService")
        protected FieldInteger cdMonth;
        @XmlElement(name = "DatCustomerAddress", namespace = "http://sphinx.dat.de/services/VehicleIdentificationService")
        ...
        @XmlElement(name = "VAT")
        protected VAT vat;
        @XmlElement(name = "Management", namespace = "http://sphinx.dat.de/services/VehicleIdentificationService")
        ...
        @XmlElement(name = "ChangeUserId", namespace = "http://sphinx.dat.de/services/VehicleIdentificationService")
        protected FieldInteger changeUserId;
        @XmlElement(name = "CreateUserId", namespace = "http://sphinx.dat.de/services/VehicleIdentificationService")
        protected FieldInteger createUserId;
        @XmlElement(name = "WearCalculation", namespace = "http://sphinx.dat.de/services/VehicleIdentificationService")
        protected FieldBoolean wearCalculation;
        @XmlElement(name = "InsuranceClaim", namespace = "http://sphinx.dat.de/services/VehicleIdentificationService")
        ...
        @XmlElement(name = "TelematicData")
        protected TelematicData telematicData;
        ...
        /**
         * Ruft den Wert der telematicData-Eigenschaft ab.
         * 
         * @return
         *     possible object is
         *     {@link TelematicData }
         *     
         */
        public TelematicData getTelematicData() {
            return telematicData;
        }

        /**
         * Legt den Wert der telematicData-Eigenschaft fest.
         * 
         * @param value
         *     allowed object is
         *     {@link TelematicData }
         *     
         */
        public void setTelematicData(TelematicData value) {
            this.telematicData = value;
        }
