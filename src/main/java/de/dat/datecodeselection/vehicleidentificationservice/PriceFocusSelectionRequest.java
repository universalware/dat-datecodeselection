 ...
 *   &lt;complexContent>
 *     &lt;extension base="{http://sphinx.dat.de/services/VehicleIdentificationService}basicSelectionRequest">
 *       &lt;sequence>
...
@XmlType(name = "priceFocusSelectionRequest", namespace = "http://sphinx.dat.de/services/VehicleIdentificationService", propOrder = {
    "datECode"
})
@XmlSeeAlso({
