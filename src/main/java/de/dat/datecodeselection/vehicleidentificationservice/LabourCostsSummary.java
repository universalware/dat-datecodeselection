 ...
 *         &lt;element name="ParkingDents" type="{http://www.dat.de/vxs}detailBlockSummary" minOccurs="0" form="qualified"/>
 *         &lt;element name="ParkingDentsLacquerDeduction" type="{http://www.dat.de/vxs}detailBlockSummary" minOccurs="0" form="qualified"/>
...
public class LabourCostsSummary {
    ...
    @XmlElement(name = "ParkingDents")
    protected DetailBlockSummary parkingDents;
    @XmlElement(name = "ParkingDentsLacquerDeduction")
    protected DetailBlockSummary parkingDentsLacquerDeduction;
    ...
    /**
     * Ruft den Wert der parkingDents-Eigenschaft ab.
     * 
     * @return
     *     possible object is
     *     {@link DetailBlockSummary }
     *     
     */
    public DetailBlockSummary getParkingDents() {
        return parkingDents;
    }

    /**
     * Legt den Wert der parkingDents-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link DetailBlockSummary }
     *     
     */
    public void setParkingDents(DetailBlockSummary value) {
        this.parkingDents = value;
    }

    /**
     * Ruft den Wert der parkingDentsLacquerDeduction-Eigenschaft ab.
     * 
     * @return
     *     possible object is
     *     {@link DetailBlockSummary }
     *     
     */
    public DetailBlockSummary getParkingDentsLacquerDeduction() {
        return parkingDentsLacquerDeduction;
    }

    /**
     * Legt den Wert der parkingDentsLacquerDeduction-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link DetailBlockSummary }
     *     
     */
    public void setParkingDentsLacquerDeduction(DetailBlockSummary value) {
        this.parkingDentsLacquerDeduction = value;
    }
