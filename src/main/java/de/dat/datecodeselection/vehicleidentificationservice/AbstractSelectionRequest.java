...
@XmlType(name = "abstractSelectionRequest", namespace = "http://sphinx.dat.de/services/VehicleIdentificationService", propOrder = {
    "locale",
    "sessionID"
})
@XmlSeeAlso({
    TypecodeSelectionToyotaRequest.class,
    TypecodeSelectionRequest.class,
    BasicSelectionRequest.class,
    VinSelectionRequest.class
})
