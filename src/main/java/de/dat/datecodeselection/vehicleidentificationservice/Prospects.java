 ...
 *       &lt;sequence>
 *         &lt;element name="Prospect" type="{http://www.dat.de/vxs}address" maxOccurs="unbounded" minOccurs="0" form="qualified"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class Prospects {
    ...
    protected List<Address> prospect;
     ...
     * 
     */
    public List<Address> getProspect() {
        if (prospect == null) {
            prospect = new ArrayList<Address>();
        }
