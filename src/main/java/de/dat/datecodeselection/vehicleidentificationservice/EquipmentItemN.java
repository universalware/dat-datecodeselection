 ...
 *       &lt;sequence>
 *         &lt;element name="EquipmentId" type="{http://www.dat.de/vxs}fieldInteger" minOccurs="0" form="qualified"/>
 *         &lt;element name="EquipmentDescription" type="{http://www.dat.de/vxs}fieldString" minOccurs="0" form="qualified"/>
...
@XmlRootElement(name = "EquipmentItemN")
public class EquipmentItemN {

    @XmlElement(name = "EquipmentId")
    protected FieldInteger equipmentId;
    @XmlElement(name = "EquipmentDescription")
    protected FieldString equipmentDescription;
     ...
     *     
     */
    public FieldInteger getEquipmentId() {
        return equipmentId;
    }
     ...
     *     
     */
    public void setEquipmentId(FieldInteger value) {
     ...
     *     
     */
    public FieldString getEquipmentDescription() {
     ...
     *     
     */
    public void setEquipmentDescription(FieldString value) {
