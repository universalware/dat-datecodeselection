...
/**
 * <p>Java-Klasse für vinByLicencePlateItalyRequest complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="vinByLicencePlateItalyRequest">
 *   &lt;complexContent>
...
@XmlType(name = "vinByLicencePlateItalyRequest", namespace = "http://sphinx.dat.de/services/VehicleIdentificationService", propOrder = {
    "licencePlate"
})
public class VinByLicencePlateItalyRequest {
