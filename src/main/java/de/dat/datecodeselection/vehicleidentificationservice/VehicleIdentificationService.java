...
public interface VehicleIdentificationService {
    ...
    @RequestWrapper(localName = "getVehicleIdentificationByTypecodeToyota", targetNamespace = "http://sphinx.dat.de/services/VehicleIdentificationService", className = "de.dat.datecodeselection.vehicleidentificationservice.GetVehicleIdentificationByTypecodeToyota")
    @ResponseWrapper(localName = "getVehicleIdentificationByTypecodeToyotaResponse", targetNamespace = "http://sphinx.dat.de/services/VehicleIdentificationService", className = "de.dat.datecodeselection.vehicleidentificationservice.GetVehicleIdentificationByTypecodeToyotaResponse")
    ...
    public de.dat.datecodeselection.vehicleidentificationservice.GetVehicleIdentificationByTypecodeToyotaResponse.VXS getVehicleIdentificationByTypecodeToyota(
     ...
     * @param request
     * @return
     *     returns de.dat.datecodeselection.vehicleidentificationservice.GetVehicleIdentificationByNationalCodeAustriaResponse.VXS
     */
    @WebMethod(action = "getVehicleIdentificationByNationalCodeAustria")
    @WebResult(name = "VXS", targetNamespace = "")
    @RequestWrapper(localName = "getVehicleIdentificationByNationalCodeAustria", targetNamespace = "http://sphinx.dat.de/services/VehicleIdentificationService", className = "de.dat.datecodeselection.vehicleidentificationservice.GetVehicleIdentificationByNationalCodeAustria")
    @ResponseWrapper(localName = "getVehicleIdentificationByNationalCodeAustriaResponse", targetNamespace = "http://sphinx.dat.de/services/VehicleIdentificationService", className = "de.dat.datecodeselection.vehicleidentificationservice.GetVehicleIdentificationByNationalCodeAustriaResponse")
    ...
    public de.dat.datecodeselection.vehicleidentificationservice.GetVehicleIdentificationByNationalCodeAustriaResponse.VXS getVehicleIdentificationByNationalCodeAustria(
        @WebParam(name = "request", targetNamespace = "")
    ...
    @WebResult(name = "VXS", targetNamespace = "")
    @RequestWrapper(localName = "getVehicleIdentificationByCodeSwitzerland", targetNamespace = "http://sphinx.dat.de/services/VehicleIdentificationService", className = "de.dat.datecodeselection.vehicleidentificationservice.GetVehicleIdentificationByCodeSwitzerland")
    @ResponseWrapper(localName = "getVehicleIdentificationByCodeSwitzerlandResponse", targetNamespace = "http://sphinx.dat.de/services/VehicleIdentificationService", className = "de.dat.datecodeselection.vehicleidentificationservice.GetVehicleIdentificationByCodeSwitzerlandResponse")
    ...
    public de.dat.datecodeselection.vehicleidentificationservice.GetVehicleIdentificationByCodeSwitzerlandResponse.VXS getVehicleIdentificationByCodeSwitzerland(
        @WebParam(name = "request", targetNamespace = "")
     ...
     * @param request
     * @return
     *     returns de.dat.datecodeselection.vehicleidentificationservice.GetVehicleIdentificationResponse.VXS
     */
    @WebMethod(action = "getVehicleIdentification")
    @WebResult(name = "VXS", targetNamespace = "")
    @RequestWrapper(localName = "getVehicleIdentification", targetNamespace = "http://sphinx.dat.de/services/VehicleIdentificationService", className = "de.dat.datecodeselection.vehicleidentificationservice.GetVehicleIdentification")
    @ResponseWrapper(localName = "getVehicleIdentificationResponse", targetNamespace = "http://sphinx.dat.de/services/VehicleIdentificationService", className = "de.dat.datecodeselection.vehicleidentificationservice.GetVehicleIdentificationResponse")
    ...
    public de.dat.datecodeselection.vehicleidentificationservice.GetVehicleIdentificationResponse.VXS getVehicleIdentification(
        @WebParam(name = "request", targetNamespace = "")
     ...
     * @param request
     * @return
     *     returns java.util.List<de.dat.datecodeselection.vehicleidentificationservice.StringStringPair>
     */
    @WebMethod(action = "getSupportedVinWmi")
    @WebResult(name = "wmi", targetNamespace = "")
    @RequestWrapper(localName = "getSupportedVinWmi", targetNamespace = "http://sphinx.dat.de/services/VehicleIdentificationService", className = "de.dat.datecodeselection.vehicleidentificationservice.GetSupportedVinWmi")
    @ResponseWrapper(localName = "getSupportedVinWmiResponse", targetNamespace = "http://sphinx.dat.de/services/VehicleIdentificationService", className = "de.dat.datecodeselection.vehicleidentificationservice.GetSupportedVinWmiResponse")
    @Action(input = "getSupportedVinWmi", output = "http://sphinx.dat.de/services/VehicleIdentificationService/VehicleIdentificationService/getSupportedVinWmiResponse")
    public List<StringStringPair> getSupportedVinWmi(
        @WebParam(name = "request", targetNamespace = "")
    ...
    @WebResult(name = "VXS", targetNamespace = "")
    @RequestWrapper(localName = "getVehicleIdentificationByVin", targetNamespace = "http://sphinx.dat.de/services/VehicleIdentificationService", className = "de.dat.datecodeselection.vehicleidentificationservice.GetVehicleIdentificationByVin")
    @ResponseWrapper(localName = "getVehicleIdentificationByVinResponse", targetNamespace = "http://sphinx.dat.de/services/VehicleIdentificationService", className = "de.dat.datecodeselection.vehicleidentificationservice.GetVehicleIdentificationByVinResponse")
    ...
    public de.dat.datecodeselection.vehicleidentificationservice.GetVehicleIdentificationByVinResponse.VXS getVehicleIdentificationByVin(
        @WebParam(name = "request", targetNamespace = "")
     ...
     * @param request
     * @return
     *     returns de.dat.datecodeselection.vehicleidentificationservice.GetVinByLicencePlateItalyResponse.VXS
     */
    @WebMethod(action = "getVinByLicencePlateItaly")
    @WebResult(name = "VXS", targetNamespace = "")
    @RequestWrapper(localName = "getVinByLicencePlateItaly", targetNamespace = "http://sphinx.dat.de/services/VehicleIdentificationService", className = "de.dat.datecodeselection.vehicleidentificationservice.GetVinByLicencePlateItaly")
    @ResponseWrapper(localName = "getVinByLicencePlateItalyResponse", targetNamespace = "http://sphinx.dat.de/services/VehicleIdentificationService", className = "de.dat.datecodeselection.vehicleidentificationservice.GetVinByLicencePlateItalyResponse")
    ...
    public de.dat.datecodeselection.vehicleidentificationservice.GetVinByLicencePlateItalyResponse.VXS getVinByLicencePlateItaly(
        @WebParam(name = "request", targetNamespace = "")
     ...
     * @param request
     * @return
     *     returns de.dat.datecodeselection.vehicleidentificationservice.GetVinByLicencePlateSpainResponse.VinByLicencePlateSpainResponse
     */
    @WebMethod(action = "getVinByLicencePlateSpain")
    @WebResult(name = "VinByLicencePlateSpainResponse", targetNamespace = "")
    @RequestWrapper(localName = "getVinByLicencePlateSpain", targetNamespace = "http://sphinx.dat.de/services/VehicleIdentificationService", className = "de.dat.datecodeselection.vehicleidentificationservice.GetVinByLicencePlateSpain")
    @ResponseWrapper(localName = "getVinByLicencePlateSpainResponse", targetNamespace = "http://sphinx.dat.de/services/VehicleIdentificationService", className = "de.dat.datecodeselection.vehicleidentificationservice.GetVinByLicencePlateSpainResponse")
    ...
    public de.dat.datecodeselection.vehicleidentificationservice.GetVinByLicencePlateSpainResponse.VinByLicencePlateSpainResponse getVinByLicencePlateSpain(
        @WebParam(name = "request", targetNamespace = "")
     ...
     * @param request
     * @return
     *     returns de.dat.datecodeselection.vehicleidentificationservice.GetVinByLicencePlateNetherlandsResponse.LicencePlateNetherlandsResponse
     */
    @WebMethod(action = "getVinByLicencePlateNetherlands")
    @WebResult(name = "licencePlateNetherlandsResponse", targetNamespace = "")
    @RequestWrapper(localName = "getVinByLicencePlateNetherlands", targetNamespace = "http://sphinx.dat.de/services/VehicleIdentificationService", className = "de.dat.datecodeselection.vehicleidentificationservice.GetVinByLicencePlateNetherlands")
    @ResponseWrapper(localName = "getVinByLicencePlateNetherlandsResponse", targetNamespace = "http://sphinx.dat.de/services/VehicleIdentificationService", className = "de.dat.datecodeselection.vehicleidentificationservice.GetVinByLicencePlateNetherlandsResponse")
    ...
    public de.dat.datecodeselection.vehicleidentificationservice.GetVinByLicencePlateNetherlandsResponse.LicencePlateNetherlandsResponse getVinByLicencePlateNetherlands(
        @WebParam(name = "request", targetNamespace = "")
