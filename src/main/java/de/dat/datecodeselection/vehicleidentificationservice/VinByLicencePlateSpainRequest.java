...
/**
 * <p>Java-Klasse für vinByLicencePlateSpainRequest complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="vinByLicencePlateSpainRequest">
 *   &lt;complexContent>
...
@XmlType(name = "vinByLicencePlateSpainRequest", namespace = "http://sphinx.dat.de/services/VehicleIdentificationService", propOrder = {
    "licencePlate"
})
public class VinByLicencePlateSpainRequest {
