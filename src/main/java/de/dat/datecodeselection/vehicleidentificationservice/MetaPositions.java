 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.dat.de/vxs}MetaPosition" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "MetaPositions")
public class MetaPositions {

    @XmlElement(name = "MetaPosition")
    protected List<MetaPosition> metaPosition;
     ...
     * 
     */
    public List<MetaPosition> getMetaPosition() {
        if (metaPosition == null) {
            metaPosition = new ArrayList<MetaPosition>();
        }
