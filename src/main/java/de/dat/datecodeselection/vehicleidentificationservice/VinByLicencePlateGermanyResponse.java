...
@XmlRootElement(name = "VinByLicencePlateGermanyResponse", namespace = "http://sphinx.dat.de/services/VehicleIdentificationService")
public class VinByLicencePlateGermanyResponse {
