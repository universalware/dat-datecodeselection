 ...
 *   &lt;complexContent>
 *     &lt;extension base="{http://sphinx.dat.de/services/ConversionFunctionsService}constructionPeriodSelectionRequest">
 *       &lt;sequence>
...
@XmlType(name = "vehicleSelectionRequest", namespace = "http://sphinx.dat.de/services/ConversionFunctionsService", propOrder = {
    "constructionTime"
})
@XmlSeeAlso({
    EquipmentFromManufacturerCodeSelectionRequest.class
})
