 ...
 *   &lt;complexContent>
 *     &lt;extension base="{http://sphinx.dat.de/services/ConversionFunctionsService}basicSelectionRequest">
 *       &lt;sequence>
...
@XmlType(name = "priceFocusSelectionRequest", namespace = "http://sphinx.dat.de/services/ConversionFunctionsService", propOrder = {
    "datECode"
})
@XmlSeeAlso({
