 ...
 *         &lt;element name="OriginalPriceGrossUser" type="{http://www.dat.de/vxs}fieldDecimal" minOccurs="0" form="qualified"/>
 ...
 *         &lt;element name="AddedByLogikCheck" type="{http://www.dat.de/vxs}fieldBoolean" minOccurs="0" form="qualified"/>
...
public class EquipmentPosition {
    ...
    @XmlElement(name = "OriginalPriceGrossUser")
    protected FieldDecimal originalPriceGrossUser;
    ...
    @XmlElement(name = "AddedByLogikCheck")
    protected FieldBoolean addedByLogikCheck;
    ...
    /**
     * Ruft den Wert der originalPriceGrossUser-Eigenschaft ab.
     * 
     * @return
     *     possible object is
     *     {@link FieldDecimal }
     *     
     */
    public FieldDecimal getOriginalPriceGrossUser() {
        return originalPriceGrossUser;
    }

    /**
     * Legt den Wert der originalPriceGrossUser-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link FieldDecimal }
     *     
     */
    public void setOriginalPriceGrossUser(FieldDecimal value) {
        this.originalPriceGrossUser = value;
    }
    ...
    /**
     * Ruft den Wert der addedByLogikCheck-Eigenschaft ab.
     * 
     * @return
     *     possible object is
     *     {@link FieldBoolean }
     *     
     */
    public FieldBoolean getAddedByLogikCheck() {
        return addedByLogikCheck;
    }

    /**
     * Legt den Wert der addedByLogikCheck-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link FieldBoolean }
     *     
     */
    public void setAddedByLogikCheck(FieldBoolean value) {
        this.addedByLogikCheck = value;
    }
