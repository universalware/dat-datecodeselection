...
/**
 * <p>Java-Klasse für getExistingEquipmentN complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="getExistingEquipmentN">
 *   &lt;complexContent>
...
@XmlType(name = "getExistingEquipmentN", namespace = "http://sphinx.dat.de/services/ConversionFunctionsService", propOrder = {
    "request"
})
public class GetExistingEquipmentN {
