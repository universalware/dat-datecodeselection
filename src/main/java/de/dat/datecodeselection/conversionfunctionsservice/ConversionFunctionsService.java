...
public interface ConversionFunctionsService {
    ...
    @RequestWrapper(localName = "date2ConstructionTime", targetNamespace = "http://sphinx.dat.de/services/ConversionFunctionsService", className = "de.dat.datecodeselection.conversionfunctionsservice.Date2ConstructionTime")
    @ResponseWrapper(localName = "date2ConstructionTimeResponse", targetNamespace = "http://sphinx.dat.de/services/ConversionFunctionsService", className = "de.dat.datecodeselection.conversionfunctionsservice.Date2ConstructionTimeResponse")
     ...
     * @param request
     * @return
     *     returns de.dat.datecodeselection.conversionfunctionsservice.ValueCodeDescription
     */
    @WebMethod(action = "valueCode2Description")
    @WebResult(name = "valueCodeDescription", targetNamespace = "")
    @RequestWrapper(localName = "valueCode2Description", targetNamespace = "http://sphinx.dat.de/services/ConversionFunctionsService", className = "de.dat.datecodeselection.conversionfunctionsservice.ValueCode2Description")
    @ResponseWrapper(localName = "valueCode2DescriptionResponse", targetNamespace = "http://sphinx.dat.de/services/ConversionFunctionsService", className = "de.dat.datecodeselection.conversionfunctionsservice.ValueCode2DescriptionResponse")
    ...
    @ResponseWrapper(localName = "getExistingEquipmentNResponse", targetNamespace = "http://sphinx.dat.de/services/ConversionFunctionsService", className = "de.dat.datecodeselection.conversionfunctionsservice.GetExistingEquipmentNResponse")
